...
import { Formik } from "formik"; //handle form values, validation, and submission
...
const Form = () => {
  ...
  const register = async (values, onSubmitProps) => {
    ...
    onSubmitProps.resetForm(); //from formik
  ...
  //POST-ing login data to server for verification/auth
      ...
      {({
        ...
        <form onSubmit={handleSubmit}>
          <Box
            ...
            sx={{
              // any div right below 'Box' -- on mobile screens they take up 4 cols
